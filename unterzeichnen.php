...
<div class="container container-fluid">
<fieldset>
<legend class=ml-2>Stellungnahme unterzeichnen</legend>
    ...
    <table cellspacing= "0" cellpadding="0">
        ...
        <!-- <tr>
			...
			<select name="status" required>
				<option value="owner">Inhaberin/Inhaber</option>
				<option value="stakeholder">Gesellschafterin/Gesellschafter</option>
                <option value="md">Geschäftsführerin/Geschäftsführer</option>
                <option value="prok">Prokuristin/Prokurist</option>
			</select>
		</td>
        </tr>  -->
        <tr>
            <th>Website</th>
            <td><input  type="text" name= "url" placeholder="Website, z.B. https://entrepreneurs4future.de" required></td>
        </tr>  
        <tr>
            <th>Stadt/Ort</th>
        ...
        <tr>
            ...
            <td><button class="btn btn-warning mt-4" type ="submit">UNTERZEICHNEN</button></td>
